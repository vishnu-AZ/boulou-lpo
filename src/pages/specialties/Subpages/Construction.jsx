...
import lpoinc from "../../../../public/assets/lpo1/Contract&Agreement Support.jpg";
import topinc from "../../../../public/assets/lpo1/ResolvingDisputes.jpg";
import cxxinc from "../../../../public/assets/lpo1/qqqq.jpg";
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        We assist law firms with thorough contract review, drafting support, and document organization, ensuring all construction agreements are precise and compliant.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                       Our teams provide detailed case summaries, evidence management, and research to help attorneys support clients in dispute resolution efficiently.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12">
                  <div className="transform-card" style={{ minHeight: '400px' }}>
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        From due diligence to compliance checks, we handle back-office tasks that allow attorneys to safeguard clients’ financial and property interests.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-xl-8 col-lg-8">
                    ...
                    >
                      <h2 class="title" data-aos="fade-up" data-aos-delay="400">
                        Reliable Support for Every Construction Matter
                      </h2>
